...
import AddPlant from "./components/AddPlants";
    ...
    return (
      <div className="min-h-screen bg-[#F4F5F0] flex items-center justify-center pt-24">
        <div className="text-center max-w-md px-4">
          ...
          <p className="text-[#1A2F1C]/60 mb-6">
            {error || "This garden doesn't exist"}
          </p>
          <button
        ...
        <div className="flex-1 px-6 md:px-12 lg:px-20">
          <div className="max-w-7xl mx-auto">
                  ...
                  <div className="flex items-center gap-4 mt-4">
                    <div className="bg-white px-4 py-2 rounded-full border border-[#1A2F1C]/10">
                      <span className="font-mono text-xs uppercase tracking-widest text-[#1A2F1C]/60">
                        {garden.plantCount}{" "}
                        {garden.plantCount === 1 ? "Plant" : "Plants"}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            {garden.plants && garden.plants.length > 0 ? (
              <div>
                <h2 className="font-serif text-3xl text-[#1A2F1C] mb-6">
              ...
              <div className="text-center py-20 bg-white/50 rounded-xl border-2 border-dashed border-[#1A2F1C]/10">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-white text-[#1A2F1C] border border-[#1A2F1C]/10 mx-auto px-5 py-3 rounded-full font-bold text-[10px] uppercase tracking-widest hover:bg-[#F4F5F0] transition-colors shadow-sm"
                >
                ...
                <AddPlant
                  ...
                  onPlantAdded={() => fetchGardenDetails()} // Refreshes your page when a plant is added!
                />
              </div>
            )}
          </div>
