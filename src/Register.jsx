  ...
  return (
    <div className="min-h-screen flex bg-[#F4F5F0] mt-15">
      ...
      <div className="hidden md:block w-1/2 relative overflow-hidden">
        ...
        {/* DIFFERENT IMAGE: Focus on growth/seeds for "Creation" */}
        <img 
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-8 md:px-24 relative py-12">
        ...
        <div className="w-full max-w-md space-y-10">
          ...
          <form className="space-y-6">
            ...
            {/* Submit Button */}
            <button className="w-full group bg-[#1A2F1C] text-[#F4F5F0] py-4 rounded-full font-sans tracking-widest text-xs font-bold hover:bg-[#C77D63] hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-3 mt-4">
              CREATE ACCOUNT
