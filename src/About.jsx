    ...
    <div className="min-h-screen bg-[#F4F5F0] text-[#1A2F1C]">
      <section className="relative pt-32 pb-20 px-6 md:px-20 overflow-hidden">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="font-serif text-5xl sm:text-5xl  md:text-6xl leading-[1] mb-8 -ml-4">
            Growth starts with <br />
            <span className="italic text-[#4A6741] sm:text-5xl">understanding.</span>
          </h1>
          <p className="font-sans text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            The Art of Farming is a digital sanctuary designed to bridge the gap
            between ancient botanical wisdom and modern agricultural science.
          </p>
        </div>
        ...
        <div className="bg-[#1A2F1C] text-[#F4F5F0] p-12 md:p-24 flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="font-sans text-[#F4F5F0]/70 text-lg leading-relaxed mb-8">
              Welcome to <strong className="text-white">Lazy Farms</strong>. We
              believe that to plant a garden is to believe in tomorrow. Whether
              you are a student, a hobbyist, or a master cultivator, our
              platform serves as your guide through the complex beauty of
              nature.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 border-t border-[#F4F5F0]/10 pt-8">
            <div>
              ...
              <p className="font-mono text-xs uppercase tracking-widest mt-1 text-[#F4F5F0]/50">
                Species Indexed
              </p>
            </div>
            <div>
      ...
      <section className="py-24 px-6 md:px-20 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl text-[#1A2F1C]">
              Why we exist.
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="group p-8 border border-gray-100 rounded-2xl hover:shadow-xl transition-all duration-500 hover:-translate-y-2 bg-[#F4F5F0]/30">
              ...
              <h3 className="font-serif text-xl font-bold mb-3 text-[#1A2F1C]">
                Botanical Intelligence
              </h3>
              <p className="font-sans text-gray-500 text-sm leading-relaxed">
                Access detailed data on growth habits, soil pH, and climate
                suitability. We translate complex horticultural science into
                actionable advice.
              </p>
            </div>
            ...
            <div className="group p-8 border border-gray-100 rounded-2xl hover:shadow-xl transition-all duration-500 hover:-translate-y-2 bg-[#F4F5F0]/30">
              ...
              <p className="font-sans text-gray-500 text-sm leading-relaxed">
                From the Himalayas to the Andes, explore the native regions of
                your plants. Understand the cultural significance behind every
                leaf.
              </p>
            </div>
            ...
            <div className="group p-8 border border-gray-100 rounded-2xl hover:shadow-xl transition-all duration-500 hover:-translate-y-2 bg-[#F4F5F0]/30">
              ...
              <p className="font-sans text-gray-500 text-sm leading-relaxed">
                We are a learning platform first. Our goal is to foster
                environmental awareness and sustainable growing practices for
                the next generation.
              </p>
            </div>
          </div>
